...
if ( ! function_exists( 'sycomp_b2b_catalogue_category_icon_url' ) ) {
	...
	function sycomp_b2b_catalogue_category_icon_url( $slug ) {
		...
		$aliases = array(
			...
			'monitors_display_accessories'  => 'monitors_displays',
			...
			'keyboard'                      => 'keyboards',
			'mouse'                         => 'mice_pointing_devices',
			'mice'                          => 'mice_pointing_devices',
			'privacy_screen'                => 'privacy_screens',
			'stands'                        => 'stands_mounts',
			'mounts'                        => 'stands_mounts',
			'webcam'                        => 'webcams',
		);
